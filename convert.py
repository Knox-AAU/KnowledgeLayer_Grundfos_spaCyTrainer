...
TEST_DATA = [('The F15 aircraft uses a lot of fuel', {'entities': [(4, 7, 'aircraft')]}),
...
if __name__ == "__main__":
    ...
    eval_path = args[3]
    convert()
    # Fill in defaults of config file generated by spaCy website: python -m spacy init fill-config base_config.cfg config.cfg
    os.system("python -m spacy train " + config_path + " --output " + output_path + " --paths.train " + train_path + " --paths.dev " + eval_path)
